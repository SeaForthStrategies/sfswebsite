...
export function ClientsMarquee({
  ...
  return (
    <div className={className} aria-label={label}>
      <div className="marquee hairline bg-surface shadow-soft rounded-[var(--radius-lg)] border px-5 py-5 [--marquee-gap:1.25rem] sm:px-7 sm:py-7 sm:[--marquee-gap:2.25rem] dark:border-black/10 dark:bg-white">
